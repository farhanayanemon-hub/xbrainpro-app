  ...
  return (
    <div className="w-[390px] h-[844px] relative overflow-hidden bg-[#0a0a0f] font-sans text-white select-none">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div 
          className="absolute inset-[-10%] bg-cover bg-center z-0 opacity-60 animate-bg-drift"
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center pt-10 pointer-events-none">
        <img 
          ...
          alt="Hero Avatar"
          className="h-[75%] object-contain drop-shadow-[0_0_30px_rgba(236,72,153,0.4)] animate-float"
        />
        {/* Ground Glow */}
        <div className="absolute bottom-[20%] w-[250px] h-[40px] bg-cyan-500/30 blur-2xl rounded-full animate-glow-pulse"></div>
      </div>
      ...
      <div className="relative z-20 h-full flex flex-col justify-between p-4 pointer-events-auto">
        ...
        <div className="flex flex-col gap-3 pt-8">
          ...
          <div className="flex justify-between gap-2">
            <div className="flex-1 glass-panel rounded-xl flex items-center p-1.5 border border-amber-500/20 relative overflow-hidden overflow-hidden-shimmer animate-shimmer">
              ...
              <span className="ml-2 font-black text-amber-100 text-sm flex-1 relative z-10">12,450</span>
              <button className="w-6 h-6 rounded-md bg-amber-500/20 flex items-center justify-center text-amber-400 relative z-10">
                <Plus className="w-4 h-4" />
              </button>
            </div>

            <div className="flex-1 glass-panel rounded-xl flex items-center p-1.5 border border-cyan-500/20 relative overflow-hidden overflow-hidden-shimmer animate-shimmer delay-100">
              ...
              <span className="ml-2 font-black text-cyan-100 text-sm flex-1 relative z-10">1,200</span>
              <button className="w-6 h-6 rounded-md bg-cyan-500/20 flex items-center justify-center text-cyan-400 relative z-10">
                <Plus className="w-4 h-4" />
              </button>
            </div>
          </div>
        ...
        <div className="absolute right-4 top-1/2 -translate-y-1/2 flex flex-col gap-4">
          <button className="button-pop group flex flex-col items-center gap-1 animate-slide-pop delay-100">
          ...
          <button className="button-pop group flex flex-col items-center gap-1 animate-slide-pop delay-200">
          ...
          <button className="button-pop group flex flex-col items-center gap-1 animate-slide-pop delay-300">
          ...
          <button className="button-pop group flex flex-col items-center gap-1 animate-slide-pop delay-400">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-yellow-300 to-amber-600 border border-yellow-200 flex items-center justify-center animate-vip-shine">
        ...
        <div className="absolute left-4 top-1/2 -translate-y-1/2 flex flex-col gap-4">
          <button className="button-pop group flex flex-col items-center gap-1 animate-slide-pop-left delay-100">
          ...
          <button className="button-pop group flex flex-col items-center gap-1 animate-slide-pop-left delay-200">
            <div className="w-12 h-12 rounded-full glass-panel bg-slate-800/60 border border-slate-500/50 flex items-center justify-center">
          ...
          <button className="button-pop group flex flex-col items-center gap-1 animate-slide-pop-left delay-300">
        ...
        <div className="pb-6 pt-2 flex flex-col items-center w-full gap-4 relative z-20">
          ...
          {/* Main Action */}
          <button className="button-pop w-[85%] bg-gradient-to-b from-cyan-300 via-cyan-500 to-blue-700 p-1 rounded-3xl animate-main-btn-glow-cyan overflow-hidden-shimmer animate-shimmer">
            <div className="bg-gradient-to-r from-cyan-400 to-blue-500 w-full py-4 rounded-2xl flex items-center justify-center gap-3 border-t-2 border-cyan-200 border-b-4 border-blue-900 relative z-10">
